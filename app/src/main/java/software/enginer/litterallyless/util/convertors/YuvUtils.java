...
public class YuvUtils {
    ...
    public static void parallelFillArgbArray(YuvData data, int startX, int endX, int startY, int endY, int[] argbArray){
        parallelFillArgbArray(new YuvDataSection(data,startX, endX, startY, endY), argbArray);
    }
    public static void parallelFillArgbArray(YuvData data, int[] argbArray){
        parallelFillArgbArray(new YuvDataSection(data,0, data.getWidth(), 0, data.getHeight()), argbArray);
    }
    public static void parallelFillArgbArray(YuvDataSection section, int[] argbArray){

        IntStream.range(section.getStartY(), section.getEndY()).parallel().forEach(y -> {
            IntStream.range(section.getStartX(), section.getEndX()).forEach(x -> {
                int r, g, b;
                int yValue;
                int uValue;
                int vValue;
